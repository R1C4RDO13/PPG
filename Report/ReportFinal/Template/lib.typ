...
#let lncs(
  ...
  set std.bibliography(title: "Bibliografia", style: "springer-lecture-notes-in-computer-science")

  // Display bibliography.
  bibliography

  // Appendices — rendered after the bibliography.
  if appendix != none {
    pagebreak(weak: true)
